...
alter table ITEM disable constraint SYS_C00708929;
prompt Disabling foreign key constraints for DONATION...
alter table DONATION disable constraint SYS_C00708935;
alter table DONATION disable constraint SYS_C00708936;
prompt Disabling foreign key constraints for MAINTENANCE...
alter table MAINTENANCE disable constraint SYS_C00708942;
prompt Disabling foreign key constraints for OPERATION...
alter table OPERATION disable constraint SYS_C00708950;
alter table OPERATION disable constraint SYS_C00708951;
...
alter table ITEM enable constraint SYS_C00708929;
prompt Enabling foreign key constraints for DONATION...
alter table DONATION enable constraint SYS_C00708935;
alter table DONATION enable constraint SYS_C00708936;
prompt Enabling foreign key constraints for MAINTENANCE...
alter table MAINTENANCE enable constraint SYS_C00708942;
prompt Enabling foreign key constraints for OPERATION...
alter table OPERATION enable constraint SYS_C00708950;
alter table OPERATION enable constraint SYS_C00708951;
